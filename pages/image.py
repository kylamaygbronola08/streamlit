...
st.set_page_config(layout="wide", page_title="🦋Image Classification for Butterfly and Moth🦋")
...
st.write("## 🦋Butterfly and Moth Classification Model🦋")
st.write("Upload an image of a butterfly, and we'll predict its classification based on our trained model!")
st.write("Prediction is limited to the ff.🦋: Cabbage White, Blue Spotted Crow, Brookes Birdwing, Brown Argus, Brown Siproeta")
...
if my_upload is not None:
    ...
    st.write("by Kyla May G. Broñola.")